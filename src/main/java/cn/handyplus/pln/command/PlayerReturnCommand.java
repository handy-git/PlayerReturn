package cn.handyplus.pln.command;
...
import cn.handyplus.pln.constants.TabListEnum;
 ...
 * @author handy
 */
@HandyCommand(name = "playerReturn")
public class PlayerReturnCommand implements TabExecutor {
    private final static String PERMISSION = "playerReturn.reload";
